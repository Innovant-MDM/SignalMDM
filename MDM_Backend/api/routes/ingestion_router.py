...
from db.sessions.database import SessionLocal, get_db
...
from db.models.upload_session import UploadSessionFile
from db.models.tenant import Tenant
from schemas.common import ok
from services.ingestion.ingestion_service import ingestion_service
from services.rawlanding.raw_service import raw_service
from services.staging.staging_service import staging_service
from db.enums import IngestionStateEnum
...
def upload_file(
    ...
    **Triggers the async raw-processing worker** which will:
    ...
    if settings.celery_enabled:
        try:
            from workers.raw_worker import process_raw_upload
